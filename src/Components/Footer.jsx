...
const Footer = () => {
  return (
    <div className="bg-[#332b25] px-8 pt-8 pb-16 relative">
      ...
      <p className="my-8 text-white">
        Ce site a été financé avec l’aide du FEDER (REACT-UE), dans le cadre de
      ...
      <div className="absolute bg-[#281e16] bottom-0 flex items-center justify-center w-full h-[7vh] left-0 p-2">
        <p className="text-xs text-white">© Copyright 2020 Lounge Garden Reunion</p>
      </div>
    </div>
  );
};
