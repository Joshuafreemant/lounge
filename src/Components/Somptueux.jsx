  ...
  return (
    <div className="p-8 bg-white">
      <div className="my-8">
        ...
        <div className="bg-[#4e3a33]  w-full text-center py-5 flex flex-col items-center justify-center">
          <h2 className=" font-kristi text-[45px] font-semibold text-[#F07D00]">
            UN ESPACE
          </h2>
          <h2 className="text-white font-lato text-[35px] font-extrabold p-4 leading-9">
            SOMPTUEUX
          </h2>
          <img src="/icon.png" className="w-5 h-5 opacity-40" alt="" />
          <p className="text-white leading-6 text-sm p-4">
